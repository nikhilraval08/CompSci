...
#Bugs- is Case Sensitive, breaks when choice is NOT 0-9 (ex- letters, integers over 9), when space is taken, turn is forfeited
...
def play_against_bot():
    ...
    def is_victory(icon):
        ...
        (playing_grid[0] == icon and playing_grid[4] == icon and playing_grid[8] == icon) or \
                (playing_grid[2] == icon and playing_grid[4] == icon and playing_grid[6] == icon):              #line 119- horizontal row 1
                                                                                                                #line 120- horizontal row 2
                                                                                                                #line 121- horizontal row 3
                                                                                                                #line 122- vertical column 1
                                                                                                                #line 123- vertical column 2
                                                                                                                #line 124- vertical column 3
                                                                                                                #line 125- diag top left to bottom right
                                                                                                                #line 126- diag top right to bottom left
            return True
        else:
            return False    
    def is_draw():
...
def play_with_friend():
    ...
    def is_victory(icon):
        ...
        (playing_grid[2] == icon and playing_grid[5] == icon and playing_grid[8] == icon) or \
        (playing_grid[0] == icon and playing_grid[4] == icon and playing_grid[8] == icon) or \
        (playing_grid[2] == icon and playing_grid[4] == icon and playing_grid[6] == icon):                      #line 228- horizontal row 1
                                                                                                                #line 229- horizontal row 2
                                                                                                                #line 230- horizontal row 3
                                                                                                                #line 231- vertical column 1
                                                                                                                #line 232- vertical column 2
                                                                                                                #line 233- vertical column 3
                                                                                                                #line 234- diag top left to bottom right
                                                                                                                #line 235- diag top right to bottom left
            return True
        else:
            return False      
    def is_draw():
